      ...
      <nav
        ...
        className={
          expanded
            ...
            : 'translate-y-[-100%] ease-in-out duration-200 lg:translate-y-0 lg:visible invisible bg-black-default min-h-auto max-w-full max-h-screen rounded-lg w-full px-4 py-8 fixed top-0 left-0 right-0 lg:relative'
        }
      >
